...
class _MenuScreenState extends State<MenuScreen> {
  ...
  String _name = (currentUser != null) ? currentUser.displayName ?? currentUser.email : "Name";
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ProgressiveImage(
        placeholder: NetworkImage(currentUser.photoURL),//AssetImage('assets/placeholder.jpg'),
        thumbnail: NetworkImage(currentUser.photoURL),
