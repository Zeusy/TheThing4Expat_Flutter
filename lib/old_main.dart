...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int _pageCount = 1;
  Future<String> _loadMorePage(int idPage) async {
    //setState(() async {
      var url = "https://mangakakalot.com/manga_list?type=latest&category=all&state=all&page=";
      var client = httpLib.Client();
      try{
        var uriResponse = await client.get(url+_pageCount.toString());
        return uriResponse.body.toString();
      } catch(e) {
        //todo: toast erreur
      }
    //});
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            //HtmlElementView(viewType: _loadMorePage(1)),
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: _incrementCounter,
        tooltip: 'Increment le conteur',
